...
rem ------------------------------------------------------------------
rem 3. Detecção Visual dos Provedores Ativos (Pre-Flight Checks)
rem ------------------------------------------------------------------
echo.
...
rem ------------------------------------------------------------------
rem 4. Execução do Daemon Principal do LumiBot
rem ------------------------------------------------------------------
echo.
...
rem ------------------------------------------------------------------
rem 5. Tratamento de Crash e Encerramento Amigável
rem ------------------------------------------------------------------
echo.
if %EXIT_CODE% NEQ 0 (
    echo ==================================================================
